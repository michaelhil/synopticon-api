...
import { createEnhancedMemoryPool, defaultMemoryPool } from '../src/utils/enhanced-memory-pool.js';
...
describe('Enhanced Memory Pool', () => {
  ...
  describe('Performance Metrics', () => {
    it('should track detailed statistics', () => {
      ...
      expect(finalStats.efficiency).toBe('25.0%'); // 1 reuse out of 4 total acquisitions
