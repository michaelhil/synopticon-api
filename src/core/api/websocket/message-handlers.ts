...
import { createMediaStreamHandler } from './media-stream-handler.js';
...
interface WebRTCMessage {
  type: 'stream_frame' | 'webrtc_offer' | 'webrtc_answer' | 'webrtc_ice' | 'webrtc_seek_broadcaster' | 'request_offer';
  deviceId?: string;
  timestamp?: number;
  data?: unknown;
  sdp?: unknown;
