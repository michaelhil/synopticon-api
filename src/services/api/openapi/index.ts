...
import { commonResponseSchemas } from './components/common-responses.ts';
import { securitySchemes } from './components/security-schemes.ts';
import { systemSchemas } from './schemas/system-schemas.ts';
import { faceDetectionSchemas } from './schemas/face-detection-schemas.ts';
import { distributionSchemas } from './schemas/distribution-schemas.ts';
import { systemPaths } from './paths/system-paths.ts';
import { faceDetectionPaths } from './paths/face-detection-paths.ts';
import { distributionPaths } from './paths/distribution-paths.ts';
