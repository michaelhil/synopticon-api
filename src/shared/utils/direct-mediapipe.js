...
// BlazeFace implementation removed - deprecated, use MediaPipe Face Detection instead
...
export const createMultiPipelineProcessor = async () => {
  ...
  const initializeProcessors = async () => {
    ...
    activeProcessor = processors.mediapipe || processors.iris || createMockProcessor();
  };
