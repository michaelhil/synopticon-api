...
import { createAnalysisResult, createErrorResult } from '../configuration/types';
import { findCompatiblePipelines, scorePipeline } from '../pipeline/pipeline';
import { createParallelInitializer } from '../performance/parallel-initializer';
import type { 
  AnalysisResult, 
...
import type { Pipeline, PipelineConfig as BasePipelineConfig } from '../pipeline/pipeline';
